...
const ProductItem = ({product}) => {
  ...
  if (
    ...
    Array.isArray(product.current_price[0].NGN) &&
  ...
  return (
    <div className="hover:shadow-shadow p-4 md:gap-2 gap-[8px] flex flex-col justify-center flex-grow box-border overflow-hidden">
        <Link to={`/products/${product.id}`}><img className=' h-[180px] w-[100%] md:h-[270px] md:w-[247px]' src={`https://api.timbu.cloud/images/${product.photos[0].url}`} alt=""/></Link>
        <div className='flex flex-col gap-2 text-[#190028]'>
          ...
          <div className='flex gap-2 justify-start items-center'>
            <div className="font-semibold text-3 text-[#190028]">N{product.current_price}</div>
