...
const Nav = () => {
  ...
  return (
    <div className='flex mx-auto max-w-[1440px] px-6 py-0 lg:px-32 lg:py-6 gap-2 lg:gap-24 justify-between items-center flex-wrap lg:flex-nowrap'>
        ...
        <input type="search" style={{border:'1px solid #C6BFC9'}} className='w-full rounded mb-2 lg:block hidden lg:mb-0 px-4 py-2 order-3 lg:order-none' placeholder='Search all Products'/>
